...
//
// FIXES THIS PASS:
// - U1c FIX: journal header + filter tabs are sticky
// ─────────────────────────────────────────────────────
(function () {
        ...
        <div>
          ...
          <div style="font-size:11px;color:#555;margin-top:2px;">
            ...
            <span style="color:${unrealColor};font-weight:700;">
              ${avgUnreal !== null
                ? (avgUnreal >= 0 ? '+' : '') + avgUnreal.toFixed(1) + '%'
                : '—'}
            </span>
          </div>
          ${urgencyHtml}
        ...
        <div style="display:flex;align-items:center;
          ...
          ${isBackfill
            ? `<span style="font-size:9px;color:#444;
                background:#1c2128;border-radius:3px;
                padding:1px 4px;border:1px solid #30363d;">gen:0</span>`
            : ''}
        </div>
        <div style="display:flex;align-items:center;
    ...
    <div id="jd-${cardId}"
      ...
      <div style="font-size:11px;color:#555;margin-bottom:4px;">
        ...
        <b style="color:${
          ...
          outcome === 'DAY6_LOSS'  ? '#f85149' : '#8b949e'
        };">
          ${outcome === 'OPEN' ? 'OPEN — tracking active'
            : outcome.replace(/_/g, ' ')}
        </b>
        ${sig.pnl_pct != null
          ? ` · P&L: <b style="color:${
...
window.renderJournal = function(tietiy) {
  ...
  // U1c FIX: sticky header + filter tabs
  let html = `
    <div style="padding-bottom:80px;">

      <!-- U1c FIX: sticky journal header + filters -->
      ...
      <!-- P&L Summary Row (only on took view) -->
      ...
      html += `
        <div style="padding:0 16px;">
          <div style="font-size:11px;color:#ffd700;
            ...
            border-top:1px solid #21262d;">
            ${_dateHeader(dateStr)}
            <span style="color:#555;font-weight:400;margin-left:6px;">
